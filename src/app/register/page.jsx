      ...
      <div className="max-w-[480px] w-full bg-[#0E131F]/50 border border-slate-800/50 rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-md">
        ...
        <div className="text-center mb-8 space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-400 font-light">
            List vehicles or rent premium rides instantly across cities
          </p>
        </div>
        ...
        <Form className="flex flex-col gap-5 w-full" onSubmit={onSubmit}>
          ...
          <TextField name="profileImgUrl" type="url">
            <Label className="text-xs font-bold text-slate-400 tracking-wide mb-1 block">
              Profile Image URL
            </Label>
            <div className="relative w-full">
          ...
          {/* Password Field with Custom Validator Style */}
          <TextField
            isRequired
            name="password"
            type="password"
          ...
          >
            ...
            <Description className="text-[11px] text-slate-500 mt-1 leading-normal">
              Must be at least 8 characters with both uppercase and lowercase
              letters.
            </Description>
            <FieldError className="text-xs text-red-400 mt-1" />
          </TextField>

          {/* HeroUI Custom Form Submit Button */}
          <Button
            type="submit"
          ...
          >
            <UserPlus className="w-4 h-4 sm:w-5 h-5 stroke-[2.5]" />
            Create Account
          </Button>
        </Form>
